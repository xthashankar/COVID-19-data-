...
.then(function(news){
 ...
 merge.style.padding = '50px';
 merge.style.alignItems = 'center';
 merge.style.width = '230px';
 merge.style.display='inline-box';
  merge.style.margin = '10px auto';
 merge.style.backgroundColor = 'yellow'


 var org=document.createElement('div')
 org.appendChild(title);
 org.appendChild(source);
 org.appendChild(profileImage);
 org.appendChild(date);
 org.appendChild(summary);
 org.appendchild(merge);
 org.style.display='table';
